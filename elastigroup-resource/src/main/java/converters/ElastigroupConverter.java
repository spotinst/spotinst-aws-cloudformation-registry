    ...
    public Elastigroup blModelToApi(Group blGroup) {
        ...
        if (blGroup != null) {
            ...
            if (blGroup.getThirdPartiesIntegration() != null){
                ...
                ElastigroupThirdPartiesIntegrationConfiguration.Builder apiThirdPartyBuilder = ElastigroupThirdPartiesIntegrationConfiguration.Builder.get();
                ...
                if (blThirdPartiesIntegration.getEcs() != null){
                    ...
                    if (blEcs.getAutoScale() != null){
                        ...
                        ElastigroupAutoScaleSpecification.Builder apiAutoScaleBuilder = ElastigroupAutoScaleSpecification.Builder.get();
                        ...
                        if (blEcsAutoScale.getShouldScaleDownNonServiceTasks() != null){
                            apiAutoScaleBuilder.setShouldScaleDownNonServiceTasks(blEcsAutoScale.getShouldScaleDownNonServiceTasks());
                        }

                        if (blEcsAutoScale.getHeadroom() != null){
                            Headroom blHeadroom = blEcsAutoScale.getHeadroom();
                            ElastigroupHeadroomSpecification.Builder apiHeadroom = ElastigroupHeadroomSpecification.Builder.get();
                        ...
                        if (blEcsAutoScale.getAttributes() != null){
                            ...
                            for (Attribute blAutoScaleAttribute : blEcsAutoScale.getAttributes()){
                                ElastigroupAttributesSpecification.Builder apiAttribute = ElastigroupAttributesSpecification.Builder.get();
                    ...
                    if (blEcs.getOptimizeImages() != null){
                        ...
                        if (blOptimizeImages.getPerformAt() != null){
                            apiOptimizedImages.setPerformAt(MaintenanceWindowTypeEnum.fromName(blOptimizeImages.getPerformAt()));
                        }
            ...
            if (blGroup.getScheduling() != null){
                ...
                ElastigroupSchedulingConfiguration.Builder apiScheduling = ElastigroupSchedulingConfiguration.Builder.get();
    ...
    private void convertApiToBlGroupScaling(ElastigroupScalingConfiguration apiScaling, Group blGroupResult) {
        ...
        if (apiScaling.getUp() != null){
            ...
            for (ScalingPolicy apiUpScalingPolicy : apiUpScalingPolicies){
                com.spotinst.elastigroup.group.ScalingPolicy blScalingPolicy = convertApiScalingPolicyToBl(apiUpScalingPolicy);
        ...
        if (apiScaling.getDown() != null){
            ...
            for (ScalingPolicy apiDownScalingPolicy : apiDownScalingPolicies){
                com.spotinst.elastigroup.group.ScalingPolicy blScalingPolicy = convertApiScalingPolicyToBl(apiDownScalingPolicy);
